...
export const HeroCards = ({
  ...
  return (
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[500px] h-[500px] scale-75 xl:scale-100">
      ...
      {/* Team */}
      <Card className="absolute right-[120px] top-4 w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 dark:shadow-white/10">
      ...
      {/* Pricing */}
      <Card className="absolute top-[190px] -left-[250px] w-72  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader>
